...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # We're retrieving the query params called tags and ingredients.
        # This is a comma separated list provided by the user as a string.
...
class BaseRecipeAttrViewSet(mixins.DestroyModelMixin,  # Allows to delete model
                            mixins.UpdateModelMixin,  # Allows to update amodel
